...
add wave -noupdate /ape_test_system_fpga_firmware_test_bench/Int_SCL_i
...
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2916959229 ps} 0} {{Cursor 2} {17169705830 ps} 0}
...
update
WaveRestoreZoom {0 ps} {6416109 ns}
